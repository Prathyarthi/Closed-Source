...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex items-center justify-center space-x-8 rounded-[16px] border border-transparent bg-white px-8 py-6 shadow-input dark:border-white/[0.2] dark:bg-gray-800"
    >
      {children}
    </nav>
  );
