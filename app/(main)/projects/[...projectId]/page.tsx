...
function ProjectPage({ params }: { params: { projectId: string } }) {
  ...
  return (
    <div className="flex h-[80vh] flex-col items-center">
      ...
      <div className="mt-5 flex h-20 w-[500px] items-center justify-between rounded-lg bg-gray-600 p-5">
        ...
        <div>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger
                onClick={() =>
                  navigator.clipboard.writeText(currentProject?.repoUrl)
                }
              >
                <Copy />
              </TooltipTrigger>
      ...
      <div className="mt-5 flex h-20 w-[500px] items-center justify-between rounded-lg bg-gray-600 p-5">
        <div className="font-bold text-black">{`Step 3: npm install`}</div>
        <div>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger
      ...
      <div className="mt-5 flex h-20 w-[500px] items-center justify-between rounded-lg bg-gray-600 p-5">
        <div className="font-bold text-black">{`Step 4: npm run dev`}</div>
        <div>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger
